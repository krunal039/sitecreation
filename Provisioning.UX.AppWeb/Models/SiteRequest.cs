...
namespace Provisioning.UX.AppWeb.Models
{
    ...
    public class SiteRequest
    {
        ...
        private List<string> _siteMembers = new List<string>();
        #endregion
        ...
        [DataMember(Name = "isSiteCollectionRequest")]
        public bool IsSiteCollectionRequest { get; set; }
        ...
        [DataMember(Name = "siteMembers")]
        public List<string> SiteMembers
        {
            get { return this._siteMembers; }
            set { this._siteMembers = value; }
        }
