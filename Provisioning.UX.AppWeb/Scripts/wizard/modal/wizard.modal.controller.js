    ...
    function WizardModalInstanceController($rootScope, common, config, $scope, $log, $modalInstance, Templates, BusinessMetadata, $utilservice, $SharePointProvisioningService) {
        ...
        $scope.finished = function () {
            ...
            if (!$scope.allFormsValid.siteResponsibilities ||
                ...
                siteRequest.siteMembers = $scope.siteConfiguration.siteMembers;
                ...
                siteRequest.isSiteCollectionRequest = $scope.siteConfiguration.properties.isSiteCollection;;
        ...
        $scope.toggleSiteCollection = function () {
            if (!$scope.siteConfiguration.properties.isSiteCollection) {
                $scope.siteConfiguration.spNewSitePrefix = decodeURIComponent(getQueryStringParameter('SPHostUrl')) + "/";
            } else {
                $scope.siteConfiguration.spNewSitePrefix = $scope.siteConfiguration.template.hostPath;
            }
        };
        ...
        $scope.selectTemplate = function (template) {
            ...
            $scope.siteConfiguration.spNewSitePrefix = decodeURIComponent(getQueryStringParameter('SPHostUrl')) + "/" // + template.managedPath + "/";
