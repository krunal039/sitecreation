...
(function () {
    ...
    angular
        .module('app.wizard')
        .controller('SiteMembersPeoplePickerController', SiteMembersPeoplePickerController);
    //.value('urlparams', null);

    SiteMembersPeoplePickerController.$inject = ['$scope', '$log', 'utilservice', 'peoplepickerfactory'];

    function SiteMembersPeoplePickerController($scope, $log, $utilservice, $peoplepickerfactory) {
        $scope.title = 'SiteMembersPeoplePickerController';
