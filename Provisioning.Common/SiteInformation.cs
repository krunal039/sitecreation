...
namespace Provisioning.Common
{
    ...
    public class SiteInformation
    {
        ...
        private List<SiteUser> _siteMembers = new List<SiteUser>();
        private bool _externalSharingEnabled = false;
        private bool _isSiteCollection = false;
        ...
        /// Additional Site Administrators
        /// </summary>
        [XmlArray(ElementName = "SiteMembers")]
        [XmlArrayItem("SharePointUser", typeof(SiteUser))]
        [JsonProperty(PropertyName = "siteMembers")]
        public List<SiteUser> AdditionalMembers
        {
            get { return _siteMembers; }
            set { _siteMembers = value; }
        }
        ...
        /// </summary>
        [DataMember]
        [JsonProperty(PropertyName = "isSiteCollectionRequest")]
        public bool IsSiteCollectionRequest
        {
            get { return this._isSiteCollection; }
            set { this._isSiteCollection = value; }
        }
