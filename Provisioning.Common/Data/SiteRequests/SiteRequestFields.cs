...
namespace Provisioning.Common.Data.SiteRequests
{
    ...
    public static class SiteRequestFields
    {
        ...
        public const string URL_DESC = "The path used for the site collection URL. Example: https://kmpdev.sharepoint.com/sites/<urlpath>";
        ...
        //Aditional Members
        public const string ADD_MEMBERS_NAME = "SP_AdditionalMembers";
        public const string ADD_MEMBERS_DISPLAYNAME = "Additional Member";
        public static readonly Guid ADD_MEMBERS_ID = new Guid("f043f1b6-ac19-44e2-8667-6c3f6a8da967");
        public const FieldType ADD_MEMBERS_TYPE = FieldType.User;
        public const string ADD_MEMBERS_ATTRIB = "Mult='TRUE' List='UserInfo' UserSelectionMode='0' ShowField='ImnName'";
        public const string ADD_MEMBERS_DESC = "Additional Members";
        ...
        //Is Site Colletion Request
        public const string SITECOLLECTION_NAME = "SP_IsSiteCollection";
        public const string SITECOLLECTION_DISPLAYNAME = "Is Site Collection Request";
        public const FieldType SITECOLLECTION_TYPE = FieldType.Boolean;
        public const string SITECOLLECTION_DESC = "";
        public const string SITECOLLECTION_ATTRIB = "ShowInDisplayForm='TRUE'";
        public static readonly Guid SITECOLLECTION_ID = new Guid("{5ea2ff4d-bf46-43fb-8da8-3fda17b7e314}");
