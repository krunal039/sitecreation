...
namespace Provisioning.Common.Data.SiteRequests.Impl
{
    ...
    internal class SPSiteRequestManager : AbstractModule, ISiteRequestManager, ISharePointClientService
    {
        ...
        const string CAML_APPROVEDREQUESTS = "<View><Query><Where><Or><And><Eq><FieldRef Name='SP_IsSiteCollection' /><Value Type='Text'>true</Value></Eq><Eq><FieldRef Name='SP_ProvisioningStatus'/><Value Type='Text'>Approved</Value></Eq></And><And><Eq><FieldRef Name='SP_IsSiteCollection' /><Value Type='Text'>false</Value></Eq><Eq><FieldRef Name='SP_ProvisioningStatus' /><Value Type='Text'>New</Value></Eq></And></Or></Where></Query><RowLimit>100</RowLimit></View>";
            ...
            UsingContext(ctx =>
            {
               ...
               Log.Info("SPSiteRequestManager.GetSiteRequestsByCaml",
                ...
                ctx.Load(_listItemCollection,
                     ...
                     item => item[SiteRequestFields.SITECOLLECTION_NAME],
