    ...
    public static class SiteRequestList
    {
        ...
        static IEnumerable<Field> CreateListFields(Web web)
        {
           ...
           fieldsXml.Add(SiteRequestFields.OWNER_NAME,
            ...
            fieldsXml.Add(SiteRequestFields.SITECOLLECTION_NAME,
                FormatField(
                SiteRequestFields.SITECOLLECTION_ID,
                SiteRequestFields.SITECOLLECTION_NAME,
                SiteRequestFields.SITECOLLECTION_TYPE,
                SiteRequestFields.SITECOLLECTION_DISPLAYNAME,
                SiteRequestFields.SITECOLLECTION_DESC,
                SiteRequestFields.DEFAULT_FIELD_GROUP,
                SiteRequestFields.SITECOLLECTION_ATTRIB));
